...
namespace NerdStore.Core.DomainObjects
{
    ...
    public class Validacoes
    {
        ...
        {
            if (valor > maximo || valor < minimo) throw new DomainException(mensagem);
        }
        ...
        public static void ValidarMinimoMaximo(decimal valor, decimal minimo, long maximo, string mensagem)
        {
            if (valor > maximo || valor < minimo) throw new DomainException(mensagem);
        }
