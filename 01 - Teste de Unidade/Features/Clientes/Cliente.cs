...
namespace Features.Clientes
{
    public class Cliente : Entity
    {
        ...
        public Cliente(Guid id, string nome, string sobrenome,  DateTime dataNascimento, 
            string email, bool ativo, DateTime dataCadastro)
        {
            Id = id;
            Nome = nome;
            Sobrenome = sobrenome;
    ...
    public class ClienteValidacao : AbstractValidator<Cliente>
    {
        ...
        {
            RuleFor(c => c.Nome)
                .NotEmpty().WithMessage("Por favor, certifique-se de ter inserido um nome")
                .Length(2, 150).WithMessage("O nome deve ter entre 2 e 150 caracteres");

            RuleFor(c => c.Sobrenome)
                .NotEmpty().WithMessage("Por favor, certifique-se de ter inserido um sobrenome")
